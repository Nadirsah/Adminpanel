...
<form action="{{route('Storeskill')}}" method="post" enctype="multipart/form-data">
    @csrf
<div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">about</label>
    <input type="text" name="about" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">  </div>
  
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">skill</label>
    <input type="text" name="skill" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
  </div>
...
<table class="table">
  ...
  @foreach($data as $baza)
    <tr>
      ...
      <td><a href="{{'Editskill/'.$baza['id']}}" class="btn btn-info"><i class="fa-solid fa-pen-to-square"></i></a></td>
      <td><a href="{{'Deleteskill/'.$baza['id']}}" class="btn btn-danger"><i class="fa-solid fa-trash"></i></a></td>
    </tr>
    @endforeach
  </tbody>
</table>
