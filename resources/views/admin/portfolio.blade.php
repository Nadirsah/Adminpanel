...
<table class="table">
  ...
  @foreach($data as $item)
    <tr>
      ...
      <th>{{$item->image}}</th>
      <td>{{$item->about}}</td>
      <td><a href="{{'Editportfolio/'.$item['id']}}" class="btn btn-info"><i class="fa-solid fa-pen-to-square"></i></a></td>
      <td><a href="{{'deleteportfolio/'.$item['id']}}" class="btn btn-danger"><i class="fa-solid fa-trash"></i></a></td>
    </tr>
    @endforeach
  </tbody>
</table>
