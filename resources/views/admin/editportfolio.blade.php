...
<body>
<form action="{{route('Upportfolio')}}" method="post" enctype="multipart/form-data">
    @csrf
...
<div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input type="file" name="images" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{$data['image']}}">
  </div>
  <div class="mb-3">
