...
<form action="{{route('StoreHomes')}}" method="post" enctype="multipart/form-data">
    @csrf
<div class="mb-3">
...
<table class="table">
  ...
  <tbody>
    <tr>
      ...
      <td>{{$data->position}}</td>
      <td>{{$data->about}}</td>
      <td><a href="{{'Edit/'.$data['id']}}" class="btn btn-info"><i class="fa-solid fa-pen-to-square"></i></a></td>
    </tr>
